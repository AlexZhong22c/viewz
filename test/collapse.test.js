...
describe('Collapse', () => {
  ...
  it('接受 selected 属性',
    ...
    div.innerHTML = `
        <z-collapse :selected="xxx">
          <z-collapse-item title="标题1" name="1"><span id="content-1">1</span></z-collapse-item>
          <z-collapse-item title="标题2" name="2"><span id="content-2">2</span></z-collapse-item>
          <z-collapse-item title="标题3" name="3"><span id="content-3">3</span></z-collapse-item>
        </z-collapse>
    `
    const vm = new Vue({
      el: div,
  ...
  it('接受 single 属性',
    ...
    document.body.appendChild(div)
    div.innerHTML = `
        <z-collapse :selected.sync="xxx" single>
          <z-collapse-item title="标题1" name="1"><span id="content-1">1</span></z-collapse-item>
          <z-collapse-item title="标题2" name="2"><span id="content-2">2</span></z-collapse-item>
          <z-collapse-item title="标题3" name="3"><span id="content-3">3</span></z-collapse-item>
        </z-collapse>
  ...
  it('触发 update:selected 事件', done => {
    ...
    document.body.appendChild(div)
    div.innerHTML = `
        <z-collapse :selected="xxx" @update:selected="onSelect">
          <z-collapse-item title="标题1" name="1"><span id="content-1">1</span></z-collapse-item>
          <z-collapse-item title="标题2" name="2"><span id="content-2">2</span></z-collapse-item>
          <z-collapse-item title="标题3" name="3"><span id="content-3">3</span></z-collapse-item>
        </z-collapse>
